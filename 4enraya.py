...
def esGanador(tablero, jugador):
    ...
    return ((b['1'] == b['2'] == b['3'] == b['4'] == p) or  # Horizontal arriba
            ...
            (b['9'] == b['10'] == b['11'] == b['12'] == p) or
            (b['13'] == b['14'] == b['15'] == b['16'] == p) or # Horizontal abajo
            (b['1'] == b['6'] == b['11'] == b['16'] == p) or  # Vertical derecha
            (b['4'] == b['7'] == b['10'] == b['13'] == p) or  # Diagonal
            (b['1'] == b['5'] == b['9'] == b['13'] == p) or
            (b['2'] == b['6'] == b['10'] == b['14'] == p) or
            (b['3'] == b['7'] == b['11'] == b['15'] == p) or
            (b['4'] == b['8'] == b['12'] == b['16'] == p)) # Diagonal
